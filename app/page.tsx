    ...
    <section className="relative py-24 px-6 lg:px-12 overflow-hidden bg-neutral-950">
      <div className="max-w-7xl mx-auto">
        <div className="relative rounded-3xl overflow-hidden bg-linear-to-br from-neutral-900 to-neutral-800 border border-neutral-700">
          ...
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-linear-to-tr from-lime-400/20 to-transparent rounded-full blur-3xl" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="mb-8 font-bold text-5xl lg:text-7xl leading-tight text-white font-serif">
                Connect with <br />
                <span className="bg-gradient-to-r from-lime-400 via-yellow-300 to-lime-400 bg-clip-text text-transparent">
                  Your Roots
                </span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <motion.button
                  className="px-8 py-4 rounded-full flex items-center gap-2 bg-gradient-to-r from-lime-400 to-yellow-300 text-neutral-950 font-semibold hover:shadow-lime-400/30 transition-shadow"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Start Exploring
...
function ExploreSection() {
  ...
  return (
    <section className="relative py-24 px-6 lg:px-12 bg-neutral-950 overflow-hidden">
      {/* Decorative glow */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-lime-400/10 via-transparent to-transparent blur-3xl" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-yellow-400/10 via-transparent to-transparent blur-3xl" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {regions.map((region, index) => (
            ...
            >
              ...
              <div className="absolute -inset-1 rounded-3xl opacity-0 group-hover:opacity-40 bg-gradient-to-r from-lime-400 via-yellow-300 to-lime-400 blur-2xl transition-opacity duration-500" />
            </motion.div>
          ))}
        </div>
        ...
        <div className="rounded-3xl p-10 lg:p-16 bg-neutral-900/60 border border-neutral-800 backdrop-blur-sm">
          <div className="grid lg:grid-cols-3 gap-10">
            {[
              ...
              >
                <div className="w-14 h-14 rounded-xl flex items-center justify-center shrink-0 bg-gradient-to-br from-lime-400 to-yellow-300 shadow-lg shadow-lime-400/30">
...
function InteractiveGarden({ mousePosition }: InteractiveGardenProps) {
  ...
  const plants = useMemo(() => {
    ...
    for (let i = 0; i < numPlants; i++) {
      ...
      const xVal = Number((r2 * 100).toFixed(4));
      const yVal = Number((r3 * 100).toFixed(4));
      const heightVal = Number((isFlower ? 40 + r4 * 30 : 60 + r4 * 50).toFixed(4));
      const widthVal = Number((isFlower ? 8 + r1 * 6 : 2 + r1 * 2).toFixed(4));
  ...
  const getInteraction = (plant: PlantItem) => {
    if (!viewportSize) return { rotation: 0, scale: 1, strength: 0, show: false };

    const plantX = (plant.x / 100) * viewportSize.width;
    const plantY = (plant.y / 100) * viewportSize.height;
    const distance = calculateDistance(mousePosition.x, mousePosition.y, plantX, plantY);
    const maxDistance = 200;

    if (distance < maxDistance) {
      const strength = 1 - distance / maxDistance;
      const angle = Math.atan2(plantY - mousePosition.y, plantX - mousePosition.x);
      const rotation = Math.cos(angle) * 20 * strength;
      const scale = 1 + strength * 0.2;
      return { rotation, scale, strength, show: distance < 100 };
    }
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-neutral-950">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-neutral-900 via-neutral-950/90 to-neutral-950" />
      </div>
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen px-6 py-24">
        ...
        >
          ...
          <p className="mb-8 text-lg text-neutral-400 leading-relaxed">
            Move your cursor to interact with the living ecosystem of cultures.
            Each plant represents a tradition, gently swaying in the winds of time.
          </p>
                  ...
                  <div className="relative flex flex-col items-center">
                    <motion.div
                      ...
                      style={{
                        ...
                        boxShadow: `0 0 ${10 + strength * 15}px rgba(163,230,53,${
                          0.4 + strength * 0.5
                        })`,
                      }}
                      animate={{ scale: [1, 1.2, 1] }}
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            <motion.button
              className="px-8 py-4 rounded-full bg-gradient-to-r from-lime-400 to-yellow-300 text-neutral-950 font-semibold shadow-md hover:shadow-lime-400/30 transition-transform"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Join Community
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-neutral-950 via-neutral-950/80 to-transparent pointer-events-none z-30" />
    </section>
  );
}
...
function CTASection() {
  return (
    <section className="relative py-28 px-6 lg:px-12 overflow-hidden bg-neutral-950">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-yellow-400/10 to-transparent blur-3xl" />

      <div className="max-w-7xl mx-auto relative">
        {/* CTA Card */}
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-neutral-900 to-neutral-800 border border-neutral-800 shadow-2xl shadow-lime-400/10">
          {/* Decorative glows */}
          <div className="absolute top-0 right-0 w-80 h-80 bg-gradient-to-br from-lime-400/20 to-transparent rounded-full blur-3xl" />
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-yellow-400/20 to-transparent rounded-full blur-3xl" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  {/* CTA Button */}
                  <motion.button
                    className="px-8 py-4 rounded-full flex items-center justify-center gap-2 bg-gradient-to-r from-lime-400 to-yellow-300 text-neutral-950 font-semibold shadow-md hover:shadow-lime-400/30 transition-transform"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    Get Started
        ...
        >
          <div className="flex flex-wrap justify-center gap-8 mb-6">
            {["About", "Features", "Community", "Cookies", "Terms"].map((link) => (
              <a
                key={link}
                href="/Cookies.html"
          ...
          <p className="text-sm text-neutral-500">
            © 2025 <span className="text-lime-400 font-semibold">Roots</span>. Connecting cultures, preserving heritage.
          </p>
        </motion.div>
      </div>
    </section>
