      ...
      <div className={`min-h-screen ${getBgColor()} ${getTextColor()} transition-colors duration-300`}>
        <div className="space-y-6 p-6">
                ...
                {activeCoupons.map((coupon) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className={`flex items-center gap-2 rounded-full px-3 py-1 border ${
                          isExpiring 
                            ...
                            : isDarkMode ? "bg-white/10 border-white/20" : "bg-white border-slate-200"
                        }`}>
                      ...
                      <p className={`mt-3 text-xs text-center ${getMutedTextColor()}`}>
          ...
          {isLoading ? (
            ...
            <div className={`rounded-2xl border p-12 text-center backdrop-blur ${getBorderColor()} ${getCardBg()}`}>
              <Ticket className={`mx-auto h-12 w-12 ${getMutedTextColor()}`} />
                    ...
                    <div className="p-6">
                      ...
                      <div className="mb-4">
                        <div className="flex items-center justify-between text-sm mb-2">
                          <span className={getMutedTextColor()}>Availability</span>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`text-sm ${getMutedTextColor()}`}>points</span>
                        </div>
                        <button
