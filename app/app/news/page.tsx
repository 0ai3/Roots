      ...
      <div className="relative min-h-screen bg-neutral-950">
        ...
        <section className="relative min-h-[40vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 py-16 text-center">
            ...
            >
              Stay{" "}
              <span className="text-lime-400">Informed</span>
            </motion.h1>
            ...
            >
              {location ? `Latest updates and important information for ${location}` : "Get personalized news and local laws for your destination"}
            </motion.p>
        ...
        <section className="relative z-20 -mt-12 pb-20">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-neutral-400">Your Location</p>
                      <p className="text-2xl font-bold text-white">{location}</p>
                      {homeCountry && (
                        <p className="text-sm text-neutral-500">Comparing with {homeCountry}</p>
                      )}
                    </div>
                  </div>
                  {isCached && (
            ...
            {isLoading ? (
              ...
              >
                <div className="text-center bg-neutral-900 rounded-2xl p-12 border border-neutral-800">
                  ...
                  <p className="mt-4 text-white text-lg font-semibold">Loading latest news and local laws...</p>
                  <p className="mt-2 text-sm text-neutral-400">This may take a few moments...</p>
                </div>
              </motion.div>
            ) : error ? (
              <motion.div
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-white mb-2">Error Loading News</p>
          ...
          <>
              ...
              {newsData.culturalTips && newsData.culturalTips.length > 0 && (
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-white">Cultural Tips</h2>
                  </div>
              ...
              {newsData.importantLaws && newsData.importantLaws.length > 0 && (
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-white">Important Laws & Differences</h2>
                  </div>
                  <div className="space-y-4">
                    {newsData.importantLaws.map((law, index) => (
                      <motion.div
                        ...
                        transition={{ delay: index * 0.1 }}
                        whileHover={{ y: -2 }}
                        className={`rounded-xl border p-6 ${getSeverityColor(law.severity)} transition-all`}
                      >
                          ...
                          <div className="flex-1">
                            ...
                            {law.comparison && (
                              <div className="mt-4 rounded-lg border border-current/20 bg-black/30 p-4">
                                ...
                                <p className="text-sm leading-relaxed">{law.comparison}</p>
                              </div>
                            )}
              ...
              {newsData.culturalNews && newsData.culturalNews.length > 0 && (
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-white">Cultural & Entertainment News</h2>
                  </div>
                      ...
                      >
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <h3 className="font-bold text-white text-lg mb-2 group-hover:text-lime-400 transition-colors">{item.title}</h3>
                            <p className="text-sm text-neutral-300 leading-relaxed mb-3">{item.summary}</p>
                            <div className="flex items-center justify-between">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-2">No Location Set</h3>
